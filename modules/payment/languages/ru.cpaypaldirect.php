...
define('CPAYPALDIRECT_DSCR', 'Обработка кредитных карт через платежную систему PayPal по методу Direct Payment.
Информация о кредитной карте вводится покупателем на вашем сайте и затем передается на сервер PayPal.
Для работы модуля необходимо, чтобы на сервере был установлен модуль PHP CURL.');
