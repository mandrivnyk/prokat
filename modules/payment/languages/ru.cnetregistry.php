...
define('CNETREGISTRY_DSCR', 
	'Обработка кредитных карт через платежную систему NetRegistry.com.au<br>Информация о кредитной карте вводится покупателем на вашем сайте и затем передается на сервер NetRegistry.com.au.<br>Для работы модуля необходимо, чтобы на сервере был установлен модуль PHP CURL и SSL-сертификат для домена, на котором работает ваш магазин.');
