...
define('CPAYPALECHECKOUT_DSCR', 'Прием платежей по PayPal по методу Express Checkout. Для работы модуля необходимо, чтобы на сервере был установлен модуль PHP cURL.');
