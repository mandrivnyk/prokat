...
define('CPAYPALDIRECT_DSCR', 'PayPal Direct Payment module allows you to accept credit card payments. Credit card information is collected on your website and then transferred to PayPal server where payment is processed.<br>Requires cURL PHP module to work. Visit PayPal website to learn more about <a href="https://www.paypal.com/cgi-bin/webscr?cmd=_wp-pro-overview-outside" target=_blank>Website Payments Pro</a>');
