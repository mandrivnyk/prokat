...
?><?php
$ob_per_list = 20;
if(!empty($_POST['fACTION'])) require './modules/linkexchange/postactions.proc.php';
...
if(isset($show_new_link)){
	...
	if(isset($_POST['LINK']))$smarty->assign('pst_LINK', html_spchars(xStripSlashesGPC($_POST['LINK'])));
}
