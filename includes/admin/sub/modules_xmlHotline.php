	...
	{   //echo $i.'  '.$products[$i]['productID'].'<br>';
		...
		$str .= "<vendor>".$products[$i]['producer']."</vendor>"."\n";
            ...
            if(($products[$i]['Price'] > 1500)
                && ($products[$i]['list_price']<$products[$i]['Price'])
                && $products[$i]['producer'] !== 'Lasting'
                && $products[$i]['producer'] !== 'Alpine pro'
                && $products[$i]['producer'] !== 'Salewa'
                && $products[$i]['producer'] !== 'Bizioni'
                && $products[$i]['producer'] !== 'Esbit'
                && $products[$i]['producer'] !== 'Osprey'
                && $products[$i]['producer'] !== 'Rock Technologies'
                && $products[$i]['producer'] !== 'Trimm'
                && $products[$i]['producer'] !== 'Turbat'
                && $products[$i]['producer'] !== 'Wind x-treme'
                && $products[$i]['producer'] !== 'Zamberlan'
            )
