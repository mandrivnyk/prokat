...
<script>
  var gUrl = 'http://zooland.in.ua/cache-test.php';  
...
//	{	
	...
	//exit;
			   ...
			   //alert(STATUS);
			    ...
			    var myAjax = new Ajax.Updater('el_cache', gUrl, {method: 'get', asynchronous: true, parameters: {from: FROM, times:time, url:URL}, evalScripts: true});     	
	//}
  }
...
<span id="el_cache"><img border="0" onclick="enable(1,5)" title="" src="/images/backend/enable-no.jpg" id="img_cache"></span>
